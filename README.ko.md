...
[시작하기](#빠른-시작) • [문서](https://yeachan-heo.github.io/ultrapower-website) • [마이그레이션 가이드](docs/MIGRATION.md)
...
> **설치:** `npm install -g @liangjie559567/ultrapower`
...
### 실행 모드
다양한 사용 사례를 위한 여러 전략 - 완전 자율 빌드부터 토큰 효율적인 리팩토링까지. [자세히 보기 →](https://yeachan-heo.github.io/ultrapower-website/docs.html#execution-modes)
...
- **44개의 전문 에이전트** - 아키텍처, 연구, 디자인, 테스팅, 데이터 사이언스
...
- **[웹사이트](https://yeachan-heo.github.io/ultrapower-website)** - 인터랙티브 가이드와 예제
