...
export class TenantIsolator {
    ...
    usage = new Map();
    guards = new Map();
    concurrency = new ConcurrencyControl();
    enforceQuota(userId, quota) {
