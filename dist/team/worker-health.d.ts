 ...
 */
export declare function getWorkerHealthReports(teamName: string, workingDirectory: string, heartbeatMaxAgeMs?: number): Promise<WorkerHealthReport[]>;
/**
 * Check if a specific worker needs intervention.
 * Returns reason string if intervention needed, null otherwise.
 */
export declare function checkWorkerHealth(teamName: string, workerName: string, workingDirectory: string, heartbeatMaxAgeMs?: number): Promise<string | null>;
