 ...
 */
export declare function readRestartState(workingDirectory: string, teamName: string, workerName: string): Promise<RestartState | null>;
/**
 ...
 */
export declare function shouldRestart(workingDirectory: string, teamName: string, workerName: string, policy?: RestartPolicy): Promise<number | null>;
/**
 * Record a restart attempt (updates sidecar state).
 */
export declare function recordRestart(workingDirectory: string, teamName: string, workerName: string, policy?: RestartPolicy): Promise<void>;
/**
 * Clear restart state for a worker (e.g., after successful recovery).
 */
export declare function clearRestartState(workingDirectory: string, teamName: string, workerName: string): Promise<void>;
/**
