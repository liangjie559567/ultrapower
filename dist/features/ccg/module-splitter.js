...
export async function splitModificationPlan(workingDir) {
...
function createDefaultModule(content) {
    return {
        name: 'Module-1',
...
async function createModuleDoc(dir, index, module) {
...
//# sourceMappingURL=module-splitter.js.map