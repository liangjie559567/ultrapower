...
export function createDeprecationWarning(info) {
...
export function wrapWithDeprecation(tool) {
...
export function createPrefixedTool(tool) {
    return {
        ...tool,
        name: `ultrapower:${tool.name}`
    };
}
export function registerToolWithBothNames(tool) {
...
//# sourceMappingURL=tool-prefix-migration.js.map