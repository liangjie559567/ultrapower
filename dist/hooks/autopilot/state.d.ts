 ...
 */
export declare function writeAutopilotState(directory: string, state: AutopilotState, sessionId?: string): Promise<boolean>;
/**
 ...
 */
export declare function initAutopilot(directory: string, idea: string, sessionId?: string, config?: Partial<AutopilotConfig>): Promise<AutopilotState | null>;
/**
 * Transition to a new phase
 */
export declare function transitionPhase(directory: string, newPhase: AutopilotPhase, sessionId?: string): Promise<AutopilotState | null>;
/**
 * Increment the agent spawn counter
 */
export declare function incrementAgentCount(directory: string, count?: number, sessionId?: string): Promise<boolean>;
/**
 * Update expansion phase data
 */
export declare function updateExpansion(directory: string, updates: Partial<AutopilotState['expansion']>, sessionId?: string): Promise<boolean>;
/**
 * Update planning phase data
 */
export declare function updatePlanning(directory: string, updates: Partial<AutopilotState['planning']>, sessionId?: string): Promise<boolean>;
/**
 * Update execution phase data
 */
export declare function updateExecution(directory: string, updates: Partial<AutopilotState['execution']>, sessionId?: string): Promise<boolean>;
/**
 * Update QA phase data
 */
export declare function updateQA(directory: string, updates: Partial<AutopilotState['qa']>, sessionId?: string): Promise<boolean>;
/**
 * Update validation phase data
 */
export declare function updateValidation(directory: string, updates: Partial<AutopilotState['validation']>, sessionId?: string): Promise<boolean>;
/**
 ...
 */
export declare function transitionRalphToUltraQA(directory: string, sessionId: string): Promise<TransitionResult>;
/**
 * Transition from UltraQA (Phase 3: QA) to Validation (Phase 4)
 */
export declare function transitionUltraQAToValidation(directory: string, sessionId?: string): Promise<TransitionResult>;
/**
 * Transition from Validation (Phase 4) to Complete
 */
export declare function transitionToComplete(directory: string, sessionId?: string): Promise<TransitionResult>;
/**
 * Transition to failed state
 */
export declare function transitionToFailed(directory: string, error: string, sessionId?: string): Promise<TransitionResult>;
/**
 ...
 */
export declare function appendCompletedStep(directory: string, step: string, sessionId?: string): Promise<boolean>;
/**
 * Record a failure reason in the state.
 */
export declare function recordFailureReason(directory: string, reason: string, sessionId?: string): Promise<boolean>;
