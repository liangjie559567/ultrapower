 ...
 */
export async function cancelAutopilot(directory, sessionId) {
 ...
 */
export async function resumeAutopilot(directory, sessionId) {
 ...
 */
export function formatFailureSummary(state) {
    const allPhases = ['expansion', 'planning', 'execution', 'qa', 'validation'];
