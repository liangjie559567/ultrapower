 ...
 */
export declare function writeUltraworkState(state: UltraworkState, directory?: string, sessionId?: string): Promise<boolean>;
/**
 * Activate ultrawork mode
 */
export declare function activateUltrawork(prompt: string, sessionId?: string, directory?: string, linkedToRalph?: boolean): Promise<boolean>;
/**
 ...
 */
export declare function incrementReinforcement(directory?: string, sessionId?: string): Promise<UltraworkState | null>;
/**
...
export declare function createUltraworkStateHook(directory: string): {
    activate: (prompt: string, sessionId?: string) => Promise<boolean>;
    deactivate: (sessionId?: string) => boolean;
    getState: (sessionId?: string) => UltraworkState | null;
    shouldReinforce: (sessionId?: string) => boolean;
    incrementReinforcement: (sessionId?: string) => Promise<UltraworkState | null>;
};
