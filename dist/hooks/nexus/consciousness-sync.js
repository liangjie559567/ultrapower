...
export function buildGitCommitMessage(sessionId, fileCount) {
...
export async function syncToRemote(directory, sessionId) {
    try {
...
//# sourceMappingURL=consciousness-sync.js.map