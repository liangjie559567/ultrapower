 ...
 */
import { EXPERT_GATE_MESSAGE, CI_GATE_MESSAGE, } from './constants.js';
export * from './types.js';
export * from './constants.js';
const WRITE_TOOLS = new Set(['Write', 'Edit', 'MultiEdit']);
export function processAxiomGuards(input) {
