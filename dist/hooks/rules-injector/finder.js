...
import { GITHUB_INSTRUCTIONS_PATTERN, MAX_TRAVERSAL_DEPTH, PROJECT_MARKERS, PROJECT_RULE_FILES, PROJECT_RULE_SUBDIRS, RULE_EXTENSIONS, USER_RULE_DIR, } from './constants.js';
/**
 ...
 */
function findRuleFilesRecursive(dir, results, depth = 0) {
    if (!existsSync(dir))
        return;
