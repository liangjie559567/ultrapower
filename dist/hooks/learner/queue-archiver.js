...
export class QueueArchiver {
    ...
    async archive() {
        ...
        try {
            ...
            const sortedDone = [...doneBlocks].sort((a, b) => extractTime(a).localeCompare(extractTime(b)));
            ...
            const mainContent = (header ? header.trimEnd() + '\n\n' : '') +
                allKept.join('\n\n') +
                '\n';
...
//# sourceMappingURL=queue-archiver.js.map