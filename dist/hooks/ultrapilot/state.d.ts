 ...
 */
export declare function writeUltrapilotState(directory: string, state: UltrapilotState, sessionId?: string): Promise<boolean>;
/**
 ...
 */
export declare function initUltrapilot(directory: string, task: string, subtasks: string[], sessionId?: string, config?: Partial<UltrapilotConfig>): Promise<UltrapilotState | null>;
/**
 * Update worker state
 */
export declare function updateWorkerState(directory: string, workerId: string, updates: Partial<WorkerState>, sessionId?: string): Promise<boolean>;
/**
 * Add a new worker
 */
export declare function addWorker(directory: string, worker: WorkerState, sessionId?: string): Promise<boolean>;
/**
 * Mark worker as complete
 */
export declare function completeWorker(directory: string, workerId: string, filesCreated: string[], filesModified: string[], sessionId?: string): Promise<boolean>;
/**
 * Mark worker as failed
 */
export declare function failWorker(directory: string, workerId: string, error: string, sessionId?: string): Promise<boolean>;
/**
 * Complete ultrapilot session
 */
export declare function completeUltrapilot(directory: string, sessionId?: string): Promise<boolean>;
/**
 ...
 */
export declare function recordConflict(directory: string, filePath: string, sessionId?: string): Promise<boolean>;
/**
