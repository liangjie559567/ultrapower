 ...
 */
function getTopAgent(agentBreakdown: Record<string, { tokens: number; cost: number }>): string {
...
export async function sessionsCommand(options: { json?: boolean; limit?: number }): Promise<void> {
