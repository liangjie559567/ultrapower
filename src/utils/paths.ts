...
/**
 * Get the plugin cache base directory for ultrapower.
 * This is the directory containing version subdirectories.
 *
 * Structure: <configDir>/plugins/cache/omc/ultrapower/
 */
export function getPluginCacheBase(): string {
  return join(getClaudeConfigDir(), 'plugins', 'cache', 'omc', 'ultrapower');
}
