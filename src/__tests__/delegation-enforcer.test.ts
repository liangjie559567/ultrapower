...
describe('delegation-enforcer', () => {
  ...
  describe('getModelForAgent', () => {
    it('returns correct model for agent with prefix', () => {
      expect(getModelForAgent('ultrapower:executor')).toBe('sonnet');
      expect(getModelForAgent('ultrapower:debugger')).toBe('sonnet');
      expect(getModelForAgent('ultrapower:architect')).toBe('opus');
    });
