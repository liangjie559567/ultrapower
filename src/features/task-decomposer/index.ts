...
function selectAgentType(component: Component): string {
  const roleToAgent: Record<ComponentRole, string> = {
    frontend: 'ultrapower:designer',
    backend: 'ultrapower:executor',
    database: 'ultrapower:executor',
    api: 'ultrapower:executor',
    ui: 'ultrapower:designer',
    shared: 'ultrapower:executor',
    testing: 'ultrapower:qa-tester',
    docs: 'ultrapower:writer',
    config: 'ultrapower:executor',
    module: 'ultrapower:executor'
  };

  return roleToAgent[component.role] || 'ultrapower:executor';
}
