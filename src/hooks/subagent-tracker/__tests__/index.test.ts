...
describe("subagent-tracker", () => {
  ...
  describe("getAgentDashboard", () => {
    ...
    it("should show tool count and last tool", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "ultrapower:architect",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
            tool_usage: [
    ...
    it("should strip ultrapower: prefix from agent type", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "ultrapower:architect-high",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
          },
      ...
      expect(dashboard).not.toContain("ultrapower:architect-high");
    });
  });
    ...
    it("should detect file conflicts between agents", () => {
      const state: SubagentTrackingState = {
        agents: [
          ...
          {
            agent_id: "agent-2",
            agent_type: "ultrapower:designer",
            started_at: new Date().toISOString(),
            parent_mode: "ultrawork",
            status: "running",
