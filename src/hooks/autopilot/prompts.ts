...
\`\`\`
Task(
  subagent_type="ultrapower:critic",
  model="opus",
...
Task(subagent_type="ultrapower:executor-low", model="haiku", prompt="...")
...
Task(subagent_type="ultrapower:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="ultrapower:architect-low",
  model="haiku",
