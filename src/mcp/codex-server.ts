...
import type { AskCodexArgs, WaitForJobArgs, CheckJobStatusArgs, KillJobArgs, ListJobsArgs } from './tool-types.js';
...
const killJobTool = tool(
  ...
  async (args: KillJobArgs) => {
    return handleKillJob('codex', args.job_id, (args.signal as NodeJS.Signals) || undefined);
  }
);
