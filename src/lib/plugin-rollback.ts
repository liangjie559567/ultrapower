 ...
 */
export function createSnapshot(plugin: string, version: string, installPath: string): SnapshotMeta {
 ...
 */
export function restoreSnapshot(plugin: string, version: string, installPath: string): boolean {
