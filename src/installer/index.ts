  ...
  try {
    ...
    if (!projectScoped) try {
      ...
      if (hudScriptPath) {
        ...
        const existingStatusLine = existingSettings.statusLine as Record<string, unknown> | undefined;
        const existingCommand = existingStatusLine?.command as string | undefined;
