...
- 6e8cca3: Native Spec Kit implementation - zero external dependencies
  - Implement complete native Spec Kit (constitution, specify, plan, tasks)
  - Add security hardening (path traversal, symlink loop prevention)
  - Intelligent project analysis and requirement generation
  - Pure TypeScript implementation, no Python/uv/specify-cli needed

- 7886d36: Add workflow gate system for superpowers discipline enforcement
...
- 1e2b359: Native Spec Kit implementation - zero external dependencies
  - Implement complete native Spec Kit (constitution, specify, plan, tasks)
  - Add security hardening (path traversal, symlink loop prevention)
  - Intelligent project analysis and requirement generation
  - Pure TypeScript implementation, no Python/uv/specify-cli needed

- 1e2b359: Add workflow gate system for superpowers discipline enforcement
