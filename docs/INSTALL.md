...
ultrapower v7.7.2 完整安装指南，覆盖从零开始到完全配置的所有步骤。
...
| TypeScript LSP | ultrapower:lsp_* 代码智能工具 |
...
**症状**：`ultrapower:lsp_hover`、`ultrapower:lsp_goto_definition` 等工具报错
