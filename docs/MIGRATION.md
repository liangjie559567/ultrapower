...
* LSP 工具（12 个）：`ultrapower:lsp_hover`、`ultrapower:lsp_goto_definition`、`ultrapower:lsp_find_references` 等
...
1. **重新运行 `/omc-setup`** 以获取新的 CLAUDE.md 配置（包含 31 个 Agent 和 55 个 Skills）
