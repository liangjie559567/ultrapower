...
1. **Consciousness Loop**：后台意识循环
2. **Self-Modifier MVP**：skill 文档级自动改进
3. **Telegram Bot**：通知 + 确认流程
4. **improvement-puller hook**：拉取改进并应用

### P2（增强）

1. **Self-Evaluator**：健康报告
2. **Self-Modifier 进阶**：TypeScript 代码级改进
3. **nexus-status/evolve/review skills**：管理界面
