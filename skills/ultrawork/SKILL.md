...
<Tool_Usage>
- Use `Task(subagent_type="ultrapower:executor-low", model="haiku", ...)` for simple changes
- Use `Task(subagent_type="ultrapower:executor", model="sonnet", ...)` for standard work
- Use `Task(subagent_type="ultrapower:executor-high", model="opus", ...)` for complex work
