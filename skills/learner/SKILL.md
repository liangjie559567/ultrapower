...
Use /ultrapower:learner ONLY after:
...
- /ultrapower:note - Save quick notes that survive compaction (less formal than skills)
- /ultrapower:ralph - Start a development loop with learning capture
