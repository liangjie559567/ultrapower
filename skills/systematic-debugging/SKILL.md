...
1. **Create Failing Test Case**
   ...
   - Use the `ultrapower:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **ultrapower:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **ultrapower:verification-before-completion** - Verify fix worked before claiming success
