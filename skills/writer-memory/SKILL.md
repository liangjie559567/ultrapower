...
| Command | Action |
|---------|--------|
| `/ultrapower:writer-memory init <project-name>` | Initialize new project memory |
| `/ultrapower:writer-memory status` | Show memory overview (character count, scene count, etc) |
| `/ultrapower:writer-memory char add <name>` | Add new character |
| `/ultrapower:writer-memory char <name>` | View character details |
| `/ultrapower:writer-memory char update <name> <field> <value>` | Update character field |
| `/ultrapower:writer-memory char list` | List all characters |
| `/ultrapower:writer-memory rel add <char1> <char2> <type>` | Add relationship |
| `/ultrapower:writer-memory rel <char1> <char2>` | View relationship |
| `/ultrapower:writer-memory rel update <char1> <char2> <event>` | Add relationship event |
| `/ultrapower:writer-memory scene add <title>` | Add new scene |
| `/ultrapower:writer-memory scene <id>` | View scene details |
| `/ultrapower:writer-memory scene list` | List all scenes |
| `/ultrapower:writer-memory theme add <name>` | Add theme |
| `/ultrapower:writer-memory world set <field> <value>` | Set world attribute |
| `/ultrapower:writer-memory query <question>` | Query memory naturally (Korean supported) |
| `/ultrapower:writer-memory validate <character> <dialogue>` | Check if dialogue matches character tone |
| `/ultrapower:writer-memory synopsis` | Generate emotion-focused synopsis |
| `/ultrapower:writer-memory export` | Export full memory as readable markdown |
| `/ultrapower:writer-memory backup` | Create manual backup |
