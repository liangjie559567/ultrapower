...
7. **On approval**: Run `/ultrapower:cancel` to cleanly exit and clean up all state files
...
- Stop when the user says "stop", "cancel", or "abort" -- run `/ultrapower:cancel`
...
- [ ] `/ultrapower:cancel` run for clean state cleanup
</Final_Checklist>
