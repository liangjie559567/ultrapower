---
name: omc-doctor
description: Diagnose and fix ultrapower installation issues
---
...
**Diagnosis**:
- If `~/.claude/agents/` exists with ultrapower-related files: WARN - legacy agents (now provided by plugin)
- If `~/.claude/commands/` exists with ultrapower-related files: WARN - legacy commands (now provided by plugin)
- If `~/.claude/skills/` exists with ultrapower-related files: WARN - legacy skills (now provided by plugin)

Look for files like:
- `architect.md`, `document-specialist.md`, `explore.md`, `executor.md`, etc. in agents/
- `ultrawork.md`, `deepsearch.md`, etc. in commands/
- Any ultrapower-related `.md` files in skills/
...
**Note**: Only remove if these contain ultrapower-related files. If user has custom agents/commands/skills, warn them and ask before removing.
