---
name: release
description: Automated release workflow for ultrapower
---

# Release Skill

Automate the release process for ultrapower.
...
Example: `/ultrapower:release 2.4.0` or `/ultrapower:release patch` or `/ultrapower:release minor`
