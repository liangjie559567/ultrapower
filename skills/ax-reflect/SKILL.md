...
> **自动归档**：每次写入新反思条目后，系统自动检查条目数；若 `count > 10`，最旧的条目将自动移至 `.omc/axiom/evolution/reflection_log_archive.md`，并输出 `[归档] reflection_log: 已移动 N 条反思至 reflection_log_archive.md`。
